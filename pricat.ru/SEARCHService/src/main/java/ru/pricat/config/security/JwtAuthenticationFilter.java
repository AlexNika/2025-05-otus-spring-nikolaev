 ...
 * Извлекает JWT из куки 'access-token', валидирует его и устанавливает аутентификацию в SecurityContextHolder.
 */
@Slf4j
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * Извлекает значение куки 'access-token' из HTTP запроса.
     *
