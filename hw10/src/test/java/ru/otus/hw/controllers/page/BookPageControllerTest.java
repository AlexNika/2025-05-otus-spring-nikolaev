...
class BookPageControllerTest {
    ...
    private List<ru.otus.hw.dto.GenreDto> genres;
    private List<CommentDto> comments;

    @BeforeEach
    void setUp() {
        AuthorDto authorDto = AuthorDto.builder().id(PRESENT_ID).fullName("Author_1").build();
        List<ru.otus.hw.dto.GenreDto> genreDtos = List.of(ru.otus.hw.dto.GenreDto.builder().id(PRESENT_ID).name("Genre_1").build());
        ...
        genres = List.of(new ru.otus.hw.dto.GenreDto(PRESENT_ID, "Genre_1"));
