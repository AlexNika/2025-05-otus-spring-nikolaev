...
public class CommentCommands {
    ...
    public String findCommentByIds(Set<String> ids) {
    ...
    public String insertComment(@Valid String text, String bookId) {
    ...
    public String updateComment(String id, @Valid String text, String bookId) {
